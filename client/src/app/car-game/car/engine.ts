import { MIN_TO_SEC, SHIFTING_VOLUME } from "../constants";
import { InvalidArgumentError } from "../invalidArgumentError";
import { Sound } from "../sound-service/sound";
import { ShiftingSound } from "../sound-service/shifting-sound";
import { IdleSound } from "../sound-service/idle-sound";
...
export class Engine {
    ...
    private _rpmSound: IdleSound;
    private _shiftingSound: ShiftingSound;
    ...
    private initializeSounds(): void {
        this._rpmSound = new IdleSound();
        this._shiftingSound = new ShiftingSound();
        this._shiftingSound.ajustVolume(SHIFTING_VOLUME);
    }
    ...
    public update(speed: number, wheelRadius: number): void {
        ...
        this._rpmSound.matchRPM(this._rpm);
        this._rpmSound.play();
    }
    ...
    public get rpmSound(): Sound {
        return this._rpmSound;
    }

    public get shiftingSound(): Sound {
        return this._shiftingSound;
    }
