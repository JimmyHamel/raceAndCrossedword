...
import { DEFAULT_WHEELBASE, DEFAULT_MASS, DEFAULT_DRAG_COEFFICIENT } from "../constants";
...
describe("Car", () => {
    ...
    it("should decelerate when brake is pressed", () => {
        ...
        car["rigidBody"]["getRollingResistance"] = () => {
            return new Vector3(0, 0, 0);
        };

        car["rigidBody"]["getDragForce"] = () => {
            return new Vector3(0, 0, 0);
        };
    ...
    it("should check validity of dragCoefficient parameter", () => {
        ...
        expect(car["rigidBody"]["dragCoefficient"]).toBe(DEFAULT_DRAG_COEFFICIENT);
    });
});
